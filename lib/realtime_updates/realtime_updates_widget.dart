...
import 'realtime_updates_model.dart';
export 'realtime_updates_model.dart';

class RealtimeUpdatesWidget extends StatefulWidget {
  const RealtimeUpdatesWidget({super.key});
...
class _RealtimeUpdatesWidgetState extends State<RealtimeUpdatesWidget>
  ...
  late RealtimeUpdatesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RealtimeUpdatesModel());
                            ...
                            child: Column(
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: Image.network(
                                    'https://images.unsplash.com/photo-1579781354186-012d7e850ad7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxkaXNlYXNlfGVufDB8fHx8MTcyMjAyNzE1MHww&ixlib=rb-4.0.3&q=80&w=1080',
                                    width: double.infinity,
                                    height: 200.0,
                                    fit: BoxFit.cover,
                                  ),
